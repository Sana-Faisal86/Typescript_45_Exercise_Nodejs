...
console.log(
  ...
  ("Sana faisal" as string) === "Sana faisal"
);
console.log(
  chalk.greenBright.underline("\tInequality test"),
  ("Sana faisal" as string) !== "Hamza faisal"
);

// • Tests using the lower case function.
console.log(
  chalk.magentaBright.underline("\n\tlowercase test"),
  "HUZAIFA FAISAL".toLowerCase() == "huzaifa faisal"
);
...
console.log(
  chalk.greenBright.underline("\tNumerical Inequality test :"),
  (20 as number) !== 30
); //inequality
