...
console.log(
  chalk.cyanBright.underline("\t==> Is car == 'subaru'? I predict true.")
);
console.log("\t1 ==>", car == "subaru");
...
console.log(
  chalk.cyanBright.underline("\t==> Is car !== 'Toyota'? I predict True.")
);
console.log("\t2 ==>", car !== "Toyota");
...
console.log(
  chalk.cyanBright.underline("\t==> Is car !== 'Ford'? I predict True.")
);
console.log("\t3 ==>", car !== "Ford");
...
console.log(
  chalk.cyanBright.underline("\t==> Is car !== 'Suzuki'? I predict True.")
);
console.log("\t4 ==>", car !== "Suzuki");
...
console.log(
  chalk.cyanBright.underline("\t==> Is car !== 'Bmw'? I predict True.")
);
console.log("\t5 ==>", car !== "Bmw");
